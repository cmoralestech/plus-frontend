    ...
    <div className="min-h-screen" style={{ background: dark1, color: cream }}>
      ...
      <section className="px-6 md:px-12 py-16 md:py-24 max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {[
            { href: "/alternatives", title: "Seeking Arrangement Review 2026", desc: "Full review with pricing, features, and verdict" },
            { href: "/switch-from-seeking", title: "Seeking Arrangement Account Banned", desc: "Why it happens and what to do next" },
            { href: "/switch-from-seeking", title: "Seeking Arrangement Not Working?", desc: "Common issues and how to fix them" },
            { href: "/switch-from-seeking", title: "Seeking Arrangement Appeal Letter", desc: "How to write an appeal that works" },
            { href: "/seeking-arrangement-alternative", title: "Seeking vs Plus: Full Comparison", desc: "Feature-by-feature breakdown" },
            { href: "/alternatives", title: "Best Dating Apps for Professionals 2026", desc: "The top apps ranked and reviewed" },
            { href: "/alternatives", title: "Best Private Dating Sites", desc: "Complete guide to every major platform" },
            { href: "/alternatives", title: "SugarDaddyMeet vs Plus", desc: "Pricing, verification, and user base compared" },
            { href: "/alternatives", title: "Luxy vs Plus", desc: "Luxury dating comparison" },
            { href: "/alternatives", title: "The League vs Plus", desc: "Both verify users, but one costs 6x more" },
            { href: "/alternatives", title: "Secret Benefits vs Plus", desc: "Credits vs subscription — which model wins?" },
            { href: "/alternatives", title: "How Much Does Seeking Cost?", desc: "Full pricing breakdown for 2026" },
